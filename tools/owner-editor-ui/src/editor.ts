...
function newPostFields(): FieldDefinition[] {
  return [
    { name: "title", label: "제목", type: "text", required: true, autocomplete: "off" },
    {
      ...
      label: "부제목",
      type: "text",
      hint: "선택 사항입니다. 게시글 제목 아래에 표시됩니다.",
      autocomplete: "off",
    },
    ...
    },
    {
      ...
      type: "text",
      placeholder: "1",
      hint: "시리즈를 지정한 경우 1 이상의 정수를 입력합니다.",
      autocomplete: "off",
    },
    {
      name: "cover",
      label: "대표 이미지 경로",
      type: "text",
      placeholder: "/assets/images/uploads/2026/07/example.webp",
      hint: "업로드한 사이트 내부 이미지 경로나 HTTPS URL을 입력합니다.",
      autocomplete: "off",
    },
    {
      name: "coverAlt",
      label: "대표 이미지 대체 텍스트",
      type: "text",
      hint: "대표 이미지가 있으면 이미지의 의미와 목적을 설명하세요.",
      autocomplete: "off",
    },
    {
      name: "featured",
    ...
    },
    {
      ...
      type: "checkbox",
      checked: true,
      hint: "사이트의 댓글 통합 설정이 완성되어 있을 때만 실제 댓글 UI가 표시됩니다.",
    },
    {
      name: "math",
      label: "수식 기능 사용",
    ...
    },
    {
      ...
      hint: "원문이 다른 주소에 있을 때만 전체 HTTPS URL을 입력합니다.",
      autocomplete: "url",
    },
    {
      name: "body",
...
export class EditorController {
  ...
  private async saveNewPost(formData: FormData): Promise<void> {
    const values: NewPostValues = {
      ...
      series: formString(formData, "series"),
      seriesOrder: formString(formData, "seriesOrder"),
      cover: formString(formData, "cover"),
      coverAlt: formString(formData, "coverAlt"),
      featured: formData.has("featured"),
      pinned: formData.has("pinned"),
      toc: formData.has("toc"),
      comments: formData.has("comments"),
      math: formData.has("math"),
      mermaid: formData.has("mermaid"),
      published: formData.has("published"),
      noindex: formData.has("noindex"),
      searchExclude: formData.has("searchExclude"),
